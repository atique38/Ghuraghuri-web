<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUpAgency.aspx.cs" Inherits="Ghuraghuri.pages.SignUpAgency" %>
        ...
        <div class="form-box signup">
            ...
            <form runat="server">
                <div class="input-box">
                    ...
                    <input id="Text1" runat="server" type="text" placeholder="Agency Name " />
                                   
                </div>
                 <div class="input-box">
                    
                    <input id="Text2" runat="server" type="text" placeholder="Owner Name "/>
                                   
                </div>
                <div class="input-box">
                
                    <input id="Text3" runat="server" type="email" placeholder="Email "/>
                                  
                </div>

                <div class="input-box">
                   
                    <input id="Text4" placeholder="Password" runat="server" type="password"/>
                      
                </div>
                <div class="input-box">
                   
                    <input id="Text5" placeholder="Address" runat="server" type="text"/>
