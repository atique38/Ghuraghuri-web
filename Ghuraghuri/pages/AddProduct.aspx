<%@ Page Title="Add Product" Language="C#" MasterPageFile="~/pages/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Ghuraghuri.pages.WebForm13" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="container">
                <div class="content">
                    <div class="info">
                        ...
                        <asp:TextBox ID="rtBox" runat="server" class="inp"></asp:TextBox>
                    </div>
                    <hr>
                </div>
            </div>
    ...
    <asp:Label ID="error" runat="server" Text="" ForeColor="#00d235"></asp:Label>
