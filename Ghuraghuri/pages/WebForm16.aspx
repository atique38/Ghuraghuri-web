<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPage.Master" AutoEventWireup="true" CodeBehind="WebForm16.aspx.cs" Inherits="Ghuraghuri.pages.WebForm16" %>
    ...
    <section class="signUp">
        <div class="sign_container">
            ...
            <div style="text-align:center;margin-top:.5rem;color:black;font-size:1rem">
                ...
                Don't have account? Sign up</asp:LinkButton>
            </div>
